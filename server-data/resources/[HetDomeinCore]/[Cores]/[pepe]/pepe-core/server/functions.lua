...
Framework.Functions.BanInjection = function(source, script)
	...
	TriggerEvent("pepe-log:server:CreateLog", "bans", "Player Banned", "orange", "Speler: "..GetPlayerName(source).." is verbannen voor het gebruiken van ServerTriggerEvents via een externe programma (Resource: "..script..")")

	Framework.Functions.ExecuteSql(false, "INSERT INTO `bans` (`name`, `steam`, `license`, `discord`,`ip`, `reason`, `expire`) VALUES ('"..GetPlayerName(source).."', '"..GetPlayerIdentifiers(source)[1].."', '"..GetPlayerIdentifiers(source)[2].."', '"..GetPlayerIdentifiers(source)[3].."', '"..GetPlayerIdentifiers(source)[4].."', '"..reason.."', "..banTime..")")

RegisterServerEvent('HDCore:DebugSomething')
AddEventHandler('HDCore:DebugSomething', function(resource, obj, depth)
...
HDCore.Debug = function(resource, obj, depth)
    TriggerEvent('HDCore:DebugSomething', resource, obj, depth)
end

HDCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

HDCore.ShowSuccess = function(resource, msg)

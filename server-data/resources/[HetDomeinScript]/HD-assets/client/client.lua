...
function SetDiscordButtons()
  SetDiscordRichPresenceAction(0, 'Connecten', 'fivem://connect/play.hetdomein.be')
  SetDiscordRichPresenceAction(1, 'Discord', 'https://discord.gg/kCKyavuAed')
end

RegisterNetEvent('HD-assets:client:seat:shuffle')
AddEventHandler('HD-assets:client:seat:shuffle', function()
...
RegisterNetEvent('HD-assets:client:me:show')
AddEventHandler('HD-assets:client:me:show', function(Text, Source)

...
StoreRob.Functions.ClosePinpad = function(HasPutin) {
    ...
    $.post('http://HD-traphouse/PinpadClose', JSON.stringify({
...
$(document).on('keydown', function() {
    switch(event.keyCode) {
        ...
        case 13:
            var v = $("#PINbox").val();
            if (v == "") {
                $.post('http://HD-traphouse/ClickFail', JSON.stringify({}))
                $.post('http://HD-traphouse/ErrorMessage', JSON.stringify({
                ...
                $("#PINbox").val("");
                $.post('http://HD-traphouse/Click', JSON.stringify({}))
                $.post('http://HD-traphouse/EnterPincode', JSON.stringify({
                    pin: data.pin
                }))

...
AddEventHandler('HDCore:Client:OnPlayerLoaded', function()
    ...
    HDCore.Functions.TriggerCallback('HD-scoreboard:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                HDCore.Functions.TriggerCallback('HD-scoreboard:server:GetActiveCops', function(cops)
...
RegisterNetEvent('HD-scoreboard:client:SetActivityBusy')
AddEventHandler('HD-scoreboard:client:SetActivityBusy', function(activity, busy)

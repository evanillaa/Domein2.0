...
[1] = {model = "qtax", label = "Mercedes S350"},
[2] = {model = "rmodgt633", label = "Mercedes GT 63"},
}

Config.Markers = {
    ['stash'] = { ['x'] = 888.64, ['y'] = -153.6728, ['z'] = 76.89108, ['h'] = 236 },
    ['boss'] = { ['x'] = 907.1562, ['y'] = -151.2437, ['z'] = 74.16836, ['h'] = 99 }
}

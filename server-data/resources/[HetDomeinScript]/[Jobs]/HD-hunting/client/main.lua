...
RegisterNetEvent('HD-hunting:client:sync:start')
AddEventHandler('HD-hunting:client:sync:start', function(source)


	if OnGoingHuntSession then

		OnGoingHuntSession = false
		TriggerServerEvent('HD-hunting:server:remove:knife')
		...
		TriggerServerEvent('HD-hunting:server:recieve:knife')
	...
	HDCore.Functions.Notify("Hunting area indicated on the map.", "success")
end)


RegisterNetEvent('HD-hunting:client:sync:stop')
AddEventHandler('HD-hunting:client:sync:stop', function(source)
	OnGoingHuntSession = false
	RemoveBlip(AnimalBlip)
	DeleteEntity(Animal)
	HDCore.Functions.Notify("Stopped with hunting", "success")
end)
...
function SlaughterAnimal(AnimalId)
    ...
    HDCore.Functions.Notify('You have skinned an animal. Weight: ' ..AnimalWeight.. 'kg')

	TriggerServerEvent('HD-hunt:reward', AnimalWeight)

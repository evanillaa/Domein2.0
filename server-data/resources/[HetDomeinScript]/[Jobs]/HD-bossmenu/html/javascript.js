...
addEventListener("message", function(event){
    ...
    if(item.open == true) {
        ...
        $.post('http://HD-bossmenu/closeNUI');
    }
});
...
$(document).on('click', '.fireemployee', function(e) {
    ...
    $.post('http://HD-bossmenu/fireEmployee', JSON.stringify({
        source: playerid,
    }));
});
...
$(document).on('click', '.grade-box', function(e) {
    ...
    $.post('http://HD-bossmenu/changeGrade', JSON.stringify({
        grade: gradeid,
...
$(document).on('click', '#option-recruit', function(e) {
    ...
    $.post('http://HD-bossmenu/openRecruit', JSON.stringify({}));
});

$(document).on('click', '#option-bosstash', function(e) {

    $.post('http://HD-bossmenu/openStash', JSON.stringify({}));
});
...
$(document).on('click', '.givejob', function(e) {
    ...
    $.post('http://HD-bossmenu/giveJob', JSON.stringify({
        source: playerid,
    }));
});
...
$(document).on('click', '.deposit', function(e) {
    $.post('http://HD-bossmenu/deposit', JSON.stringify({
        amount: currentDepositAmount,
    }));
});

$(document).on('click', '.withdraw', function(e) {
    $.post('http://HD-bossmenu/withdraw', JSON.stringify({

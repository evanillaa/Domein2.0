...
Citizen.CreateThread(function()
    while HDCore == nil do TriggerEvent("HDCore:GetObject", function(obj) HDCore = obj end) Wait(0) end
        ...
        while true do
            ...
            if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), Config.Sell, true) <= 3.0 then
                ...
                if IsControlJustReleased(0, 38) then
                    TriggerServerEvent('HD-mine:sell')
                    ...
                    if distance == -1 or distance >= 4.0 then
                        ...
                        while mining do
                            ...
                            if IsDisabledControlJustReleased(0, 24) then
                                ...
                                TriggerServerEvent('HD-mine:getItem')

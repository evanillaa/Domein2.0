...
HDCore.Functions.CreateCallback('HD-garbagejob:server:HasMoney', function(source, cb)
...
HDCore.Functions.CreateCallback('HD-garbagejob:server:CheckBail', function(source, cb)
    local Player = HDCore.Functions.GetPlayer(source)
    local CitizenId = Player.PlayerData.citizenid
...
RegisterServerEvent('HD-garbagejob:server:PayShitBakker')
AddEventHandler('HD-garbagejob:server:PayShitBakker', function(amount, location)
    local src = source

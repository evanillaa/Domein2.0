    ...
    if isLoggedIn and HDCore ~= nil then
        if PlayerJob.name == "butcher" then
            ...
            if dst <= 1 and IsControlJustPressed(0, Keys["E"]) then
                HDCore.Functions.Progressbar("hospital_checkin", "Catching Chicken", 5000, false, true)
                alivechickenanim()
                TriggerServerEvent("HD-alivechicken")
                ClearTask()
                end
            else
                Wait(2000)
    ...
    if isLoggedIn and HDCore ~= nil then
            if PlayerJob.name == "butcher" then
                ...
                if dst <= 1 and IsControlJustPressed(0, Keys["E"]) then
                    portionanim(1)
                    Wait(50)
                    TriggerServerEvent("HD-rawchicken")
                    Wait(1000)
                    end
            else
                Wait(2000)
    ...
    if isLoggedIn and HDCore ~= nil then
            if PlayerJob.name == "butcher" then
                ...
                if dst <= 2 and IsControlJustPressed(0, Keys["E"]) then
                    animpack()
                    TriggerServerEvent("HD-packchicken")
                    Wait("2000")
                end
            else
                Wait(2000)

...
-- // Events \\ --
-- Target events
RegisterNetEvent('HD-hospital:client:target:shop')
AddEventHandler('HD-hospital:client:target:shop', function()
    TriggerServerEvent("HD-inventory:server:OpenInventory", "shop", "hospital", Config.Items)
end)

RegisterNetEvent('HD-hospital:client:target:safe')
AddEventHandler('HD-hospital:client:target:safe', function()
    local Other = {maxweight = 2000000, slots = 200}
    TriggerServerEvent("HD-inventory:server:OpenInventory", "stash", "AmbulanceKast", Other)
    TriggerEvent("HD-inventory:client:SetCurrentStash", "AmbulanceKast")
end)

RegisterNetEvent('HD-hospital:client:target:checkin')
AddEventHandler('HD-hospital:client:target:checkin', function()
    TriggerServerEvent("HD-hospital:server:SendDoctorAlert")
end)

RegisterNetEvent('HD-hospital:client:target:roepdokter')
AddEventHandler('HD-hospital:client:target:roepdokter', function()
    TriggerServerEvent("HD-hospital:server:SendDoctorAlert")
end)

RegisterNetEvent('HD-hospital:client:target:toheli')
AddEventHandler('HD-hospital:client:target:toheli', function()
    DoScreenFadeOut(450)
    Citizen.Wait(450)
    TriggerEvent("HD-sound:client:play", "hospital-elevator", 0.25)
...
RegisterNetEvent('HD-hospital:client:target:tohospital')
AddEventHandler('HD-hospital:client:target:tohospital', function()
    DoScreenFadeOut(450)
    Citizen.Wait(450)
    TriggerEvent("HD-sound:client:play", "hospital-elevator", 0.25)
...
RegisterNetEvent('HD-hospital:client:target:togarage')
AddEventHandler('HD-hospital:client:target:togarage', function()
    DoScreenFadeOut(450)
    Citizen.Wait(450)
    TriggerEvent("HD-sound:client:play", "hospital-elevator", 0.25)

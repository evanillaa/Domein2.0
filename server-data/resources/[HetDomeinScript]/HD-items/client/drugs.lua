...
RegisterNetEvent('HD-items:client:joint:effect')
AddEventHandler('HD-items:client:joint:effect', function()
  OnWeed = true
  Time = 15
  while OnWeed do
    if Time > 0 then
...
RegisterNetEvent('fullsatan:GetDrunk') --- Main function to call
AddEventHandler('fullsatan:GetDrunk', function()
	level = level + 1

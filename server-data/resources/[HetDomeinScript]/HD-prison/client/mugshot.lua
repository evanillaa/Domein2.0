...
RegisterNetEvent('HD-prison:client:set:in:jail')
AddEventHandler('HD-prison:client:set:in:jail', function(Name, Months, CitizenId, Date)
...
function JailIntro(Name, Months, CitizenId, Date)
    ...
    TriggerEvent('HD-sound:client:play', 'handcuff', 0.4)
    ...
    TriggerEvent('HD-sound:client:play', 'jail-photo', 0.4)
    Citizen.Wait(3000) 
    TriggerEvent('HD-sound:client:play', 'jail-photo', 0.4)
    Citizen.Wait(3000) 
...
function AddMugshot(Name, Months, CitizenId, Date)
 ...
 exports['HD-assets']:RequestAnimationDict("mp_character_creation@lineup@male_a")

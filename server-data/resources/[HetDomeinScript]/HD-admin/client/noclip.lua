...
RegisterNetEvent('HD-admin:client:toggleNoclip')
AddEventHandler('HD-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
function turnNoClipOn()
    ...
    if ( not inVehicle ) then
        exports['HD-assets']:RequestAnimationDict("mp_sleep")
        loadedAnims = true
    end
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            HDCore.Functions.Notify("Snelheid: ".. speeds[travelSpeed])

...
RegisterNetEvent('HD-phone:client:RaceNotify')
AddEventHandler('HD-phone:client:RaceNotify', function(message)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
            IsAuthorized = IsAuthorized,
            IsBusy = exports['HD-lapraces']:IsInEditor(),
...
RegisterNUICallback('StartTrackEditor', function(data, cb)
    TriggerServerEvent('HD-lapraces:server:CreateLapRace', data.TrackName)
end)

RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:GetRacingData', function(RaceData)
        ...
        if dist <= 115.0 then
            if data.Joined then
                TriggerEvent('HD-lapraces:client:WaitingDistanceCheck')
            end
            cb(true)
        else
            HDCore.Functions.Notify('Je bent te ver van de race. Je navigatie is ingesteld naar de race.', 'error', 5000)
...
RegisterNUICallback('IsBusyCheck', function(data, cb)
    if data.check == "editor" then
        cb(exports['HD-lapraces']:IsInEditor())
    else
        cb(exports['HD-lapraces']:IsInRace())
    end
end)

RegisterNUICallback('CanRaceSetup', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)

RegisterNUICallback('GetAvailableRaces', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('JoinRace', function(data)
    TriggerServerEvent('HD-lapraces:server:JoinRace', data.RaceData)
end)

RegisterNUICallback('LeaveRace', function(data)
    TriggerServerEvent('HD-lapraces:server:LeaveRace', data.RaceData)
end)

RegisterNUICallback('StartRace', function(data)
    TriggerServerEvent('HD-lapraces:server:StartRace', data.RaceData.RaceId)
end)

RegisterNetEvent('HD-phone:client:UpdateLapraces')
AddEventHandler('HD-phone:client:UpdateLapraces', function()
    SendNUIMessage({
...
RegisterNUICallback('GetRaces', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('SetupRace', function(data, cb)
    TriggerServerEvent('HD-lapraces:server:SetupRace', data.RaceId, tonumber(data.AmountOfLaps))
end)

RegisterNUICallback('HasCreatedRace', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)

RegisterNUICallback('IsInRace', function(data, cb)
    local InRace = exports['HD-lapraces']:IsInRace()
    print(InRace)
    cb(InRace)
end)
...
--[[RegisterNetEvent('HD-phone:client:salaris')
AddEventHandler('HD-phone:client:salaris')
    if PhoneData.isOpen then
        print('geld gekregen')
    else
        SendNUIMessage({
...
RegisterNetEvent('HD-phone:client:induty')
AddEventHandler('HD-phone:client:induty', function(alert)
...
RegisterNetEvent('HD-phone:client:offduty')
AddEventHandler('HD-phone:client:offduty', function(alert)
...
RegisterNetEvent('HD-phone:client:paycheck')
AddEventHandler('HD-phone:client:paycheck', function(alert)
    ...
    if PhoneData.isOpen then
        ...
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Loonstrook",
                text = "Je loon staat nu op je bank....", 
                icon = "fas fa-clock",
                color = "#ffffff",
                timeout = 1500,
            },
...
RegisterNetEvent('HD-phone:client:AddRecentCall')
AddEventHandler('HD-phone:client:AddRecentCall', function(data, time, type)
    ...
    TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "phone")
...
RegisterNUICallback('ClearRecentAlerts', function(data, cb)
    TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "phone", 0)
...
RegisterNUICallback('SetBackground', function(data)
    ...
    TriggerServerEvent('HD-phone:server:SaveMetaData', PhoneData.MetaData)
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if isLoggedIn then
            HDCore.Functions.TriggerCallback('HD-phone:server:GetPhoneData', function(pData)   
...
function LoadPhone()
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:GetPhoneData', function(pData)
        ...
        PhoneData.PlayerData = HDCore.Functions.GetPlayerData()
...
RegisterNUICallback('HasPhone', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:HasPhone', function(HasPhone)
        cb(HasPhone)
    end)
end)
...
function OpenPhone()
   HDCore.Functions.TriggerCallback('HD-phone:server:HasPhone', function(HasPhone)
       if HasPhone then
            ...
            HDCore.Functions.TriggerCallback('HD-phone:server:GetGarageVehicles', function(vehicles)
                PhoneData.GarageVehicles = vehicles
            end)
        else
            HDCore.Functions.Notify("Je hebt geen telefoon", "error")
        end
   end)
end
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('HD-phone:server:RemoveMail', MailId)
    cb('ok')
end)

RegisterNetEvent('HD-phone:client:UpdateMails')
AddEventHandler('HD-phone:client:UpdateMails', function(NewMails)
    SendNUIMessage({
        action = "UpdateMails",
        Mails = NewMails
    })
...
RegisterNetEvent('HD-phone:client:UpdateBills')
AddEventHandler('HD-phone:client:UpdateBills', function(NewData)
...
RegisterNUICallback('AcceptMailButton', function(data)
    ...
    TriggerServerEvent('HD-phone:server:ClearButtonData', data.mailId)
end)
...
RegisterNUICallback('AddNewContact', function(data, cb)
    ...
    TriggerServerEvent('HD-phone:server:AddNewContact', data.ContactName, data.ContactNumber, data.ContactIban)
end)
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('GetInvoices', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:GetInvoiceData', function(InvoiceData)
        cb(InvoiceData)
    end)
end)
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    if PhoneData.Chats[NumberKey] ~= nil then
        if PhoneData.Chats[NumberKey].messages[ChatKey] ~= nil then
            ...
            TriggerServerEvent('HD-phone:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, false)
            ...
            TriggerServerEvent('HD-phone:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, true)
            NumberKey = GetKeyByNumber(ChatNumber)
            ReorganizeChats(NumberKey)
        end
    else
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNUICallback('SendTikkie', function(data, cb)
    ...
    --TriggerServerEvent('HD-phone:server:send:tikkie')
    HDCore.Functions.TriggerCallback('HD-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNetEvent('HD-phone:client:UpdateMessages')
AddEventHandler('HD-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
        ...
        if PhoneData.isOpen then
            ...
            Wait(100)
            HDCore.Functions.TriggerCallback('HD-phone:server:GetContactPictures', function(Chats)
                SendNUIMessage({
                    action = "UpdateChat",
            ...
            TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "whatsapp")
        end
    else
...
RegisterNetEvent("HD-phone-new:client:BankNotify")
AddEventHandler("HD-phone-new:client:BankNotify", function(text)
    SendNUIMessage({
        action = "Notification",
        NotifyData = {
            title = "Bank", 
...
RegisterNetEvent('HD-phone:client:NewMailNotify')
AddEventHandler('HD-phone:client:NewMailNotify', function(MailData)
    if PhoneData.isOpen then
        print('nieuwe mail')
    else
        SendNUIMessage({
    ...
    TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "mail")
end)

RegisterNUICallback('PostAdvert', function(data)
    TriggerServerEvent('HD-phone:server:AddAdvert', data.message)
end)

RegisterNUICallback('SellVehicle', function(data)
    TriggerServerEvent('HD-phone:server:sellVehicle', data.plate, data.price)
end)

RegisterNUICallback('BuyVehicle', function(data)
    TriggerServerEvent('HD-phone:server:buy:chosen:vehicle', data.plate, data.citizenid, data.price)
end)

RegisterNetEvent('HD-phone:client:send:email:bought:vehicle')
AddEventHandler('HD-phone:client:send:email:bought:vehicle', function(Plate)
...
RegisterNetEvent('HD-phone:client:send:email:sold:vehicle')
AddEventHandler('HD-phone:client:send:email:sold:vehicle', function(SellPrice, VehiclePlate)
    SetTimeout(math.random(4500, 8000), function()
        TriggerServerEvent('HD-phone:server:sendNewMail', {
            sender = "Autoscout24",
...
RegisterNetEvent('HD-phone:client:UpdateAdverts')
AddEventHandler('HD-phone:client:UpdateAdverts', function(Adverts, LastAd)
...
RegisterNUICallback('LoadAutoscout', function()
    HDCore.Functions.TriggerCallback('HD-phone:server:load:autoscout', function(Data)
        SendNUIMessage({
            action = "RefreshAutoscout",
            Cars = Data
        })
...
RegisterNUICallback('ClearAlerts', function(data, cb)
    ...
    if PhoneData.Chats[ChatKey].Unread ~= nil then
        ...
        TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "whatsapp", newAlerts)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('EditContact', function(data, cb)
    ...
    Citizen.Wait(100)
    cb(PhoneData.Contacts)
    TriggerServerEvent('HD-phone:server:EditContact', NewName, NewNumber, NewIban, OldName, OldNumber, OldIban)
end)
...
RegisterNetEvent('HD-phone:client:UpdateHashtags')
AddEventHandler('HD-phone:client:UpdateHashtags', function(Handle, msgData)
...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    for i = 2, #Hashtag, 1 do
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            TriggerServerEvent('HD-phone:server:UpdateHashtags', Handle, TweetMessage)
        end
    end
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            if (Firstname ~= nil and Firstname ~= "") and (Lastname ~= nil and Lastname ~= "") then
                if Firstname ~= PhoneData.PlayerData.charinfo.firstname and Lastname ~= PhoneData.PlayerData.charinfo.lastname then
                    TriggerServerEvent('HD-phone:server:MentionedPlayer', Firstname, Lastname, TweetMessage)
                else
   ...
   Citizen.Wait(100)
   cb(PhoneData.Tweets)
   TriggerServerEvent('HD-phone:server:UpdateTweets', PhoneData.Tweets, TweetMessage)      
end)

RegisterNetEvent('HD-phone:client:post:tweet:event')
AddEventHandler('HD-phone:client:post:tweet:event', function(Message, Time, Type)
    local TweetMessage = {
        firstName = 'None',
        lastName = 'None',
    ...
    table.insert(PhoneData.Tweets, TweetMessage)
    Citizen.Wait(100)
    TriggerServerEvent('HD-phone:server:UpdateTweets', PhoneData.Tweets, TweetMessage, Type) 
end)

RegisterNetEvent('HD-phone:client:NotEnoughBits')
AddEventHandler('HD-phone:client:NotEnoughBits', function(amount, newmoney)
    SendNUIMessage({
        action = "PhoneNotification",
        PhoneNotify = {
            title = "Twitter", 
...
RegisterNetEvent('HD-phone:client:TransferMoney')
AddEventHandler('HD-phone:client:TransferMoney', function(amount, newmoney)
...
RegisterNetEvent('HD-phone:client:UpdateTweets')
AddEventHandler('HD-phone:client:UpdateTweets', function(src, Tweets, NewTweetData, Type)
...
RegisterNetEvent('HD-phone:client:GetMentioned')
AddEventHandler('HD-phone:client:GetMentioned', function(TweetMessage, AppAlerts)
...
RegisterNUICallback('ClearMentions', function()
    ...
    TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "twitter", 0)
    SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
end)
...
RegisterNUICallback('ClearGeneralAlerts', function(data)
    SetTimeout(400, function()
        ...
        TriggerServerEvent('HD-phone:server:SetPhoneAlerts', data.app, 0)
        SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
    end)
end)
...
RegisterNUICallback('TransferMoney', function(data, cb)
    ...
    if tonumber(PhoneData.PlayerData.money.bank) >= data.amount then
        ...
        TriggerServerEvent('HD-phone:server:TransferMoney', data.iban, data.amount)
        local cbdata = {
            CanTransfer = true,
...
RegisterNUICallback('CallContact', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:GetCallState', function(CanCall, IsOnline)
        local status = { 
            CanCall = CanCall, 
            IsOnline = IsOnline,
...
CallContact = function(CallData, AnonymousCall)
    ...
    TriggerServerEvent('HD-phone:server:CallContact', PhoneData.CallData.TargetData, PhoneData.CallData.CallId, AnonymousCall)
    TriggerServerEvent('HD-phone:server:SetCallState', true)
        ...
        if not PhoneData.CallData.AnsweredCall then
            if RepeatCount + 1 ~= Config.CallRepeats + 1 then
                if PhoneData.CallData.InCall then
                    ...
                    TriggerEvent("HD-sound:client:play", "death", 0.1) 
                else
                    break
                end
...
CancelCall = function()
    TriggerServerEvent('HD-phone:server:CancelCall', PhoneData.CallData)
    ...
    TriggerServerEvent('HD-phone:server:SetCallState', false)
...
RegisterNetEvent('HD-phone:client:CancelCall')
AddEventHandler('HD-phone:client:CancelCall', function()
    if PhoneData.CallData.CallType == "ongoing" then
        SendNUIMessage({
...
RegisterNetEvent('HD-phone:client:GetCalled')
AddEventHandler('HD-phone:client:GetCalled', function(CallerNumber, CallId, AnonymousCall)
    local RepeatCount = 0
    local CallData = {
        number = CallerNumber,
    ...
    for i = 1, Config.CallRepeats + 1, 1 do
        if not PhoneData.CallData.AnsweredCall then
            if RepeatCount + 1 ~= Config.CallRepeats + 1 then
                if PhoneData.CallData.InCall then
                    RepeatCount = RepeatCount + 1
                    TriggerEvent("HD-sound:client:play", "phone-ringing", 0.2)
                    ...
                    TriggerServerEvent('HD-phone:server:AddRecentCall', "missed", CallData)
                    break
                end
                Citizen.Wait(Config.RepeatTimeout)
            else
...
function AnswerCall()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        ...
        TriggerServerEvent('HD-phone:server:AnswerCall', PhoneData.CallData)
...
RegisterNetEvent('HD-phone:client:AnswerCall')
AddEventHandler('HD-phone:client:AnswerCall', function()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        PhoneData.CallData.CallType = "ongoing"
        PhoneData.CallData.AnsweredCall = true
        PhoneData.CallData.CallTime = 0
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)

RegisterNUICallback('FetchVehicleResults', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:GetVehicleSearchResults', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:ScanPlate', function(result)
            result.label = modelname
            cb(result)
    end, plate)
end)

RegisterNetEvent('HD-phone:client:addPoliceAlert')
AddEventHandler('HD-phone:client:addPoliceAlert', function(alertData)
...
RegisterNUICallback('SetAlertWaypoint', function(data)
    ...
    HDCore.Functions.Notify('GPS Locatie ingesteld: '..data.alert.title)
...
RegisterNetEvent('HD-phone:client:GiveContactDetails')
AddEventHandler('HD-phone:client:GiveContactDetails', function()
    local ped = GetPlayerPed(-1)
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local PlayerId = GetPlayerServerId(player)
        TriggerServerEvent('HD-phone:server:GiveContactDetails', PlayerId)
    else
...
-- Citizen.CreateThread(function()
--     Wait(1000)
--     TriggerServerEvent('HD-phone:server:GiveContactDetails', 1)
-- end)
...
RegisterNUICallback('DeleteContact', function(data, cb)
    ...
    TriggerServerEvent('HD-phone:server:RemoveContact', Name, Number)
end)

RegisterNetEvent('HD-phone:client:AddNewSuggestion')
AddEventHandler('HD-phone:client:AddNewSuggestion', function(SuggestionData)
    ...
    Config.PhoneApplications["phone"].Alerts = Config.PhoneApplications["phone"].Alerts + 1
    TriggerServerEvent('HD-phone:server:SetPhoneAlerts', "phone", Config.PhoneApplications["phone"].Alerts)
end)

-- RegisterNUICallback('GetCryptoData', function(data, cb)
--     HDCore.Functions.TriggerCallback('qb-crypto:server:GetCryptoData', function(CryptoData)
--         cb(CryptoData)
--     end, data.crypto)
-- end)

-- RegisterNUICallback('BuyCrypto', function(data, cb)
--     HDCore.Functions.TriggerCallback('qb-crypto:server:BuyCrypto', function(CryptoData)
--         cb(CryptoData)
--     end, data)
-- end)

-- RegisterNUICallback('SellCrypto', function(data, cb)
--     HDCore.Functions.TriggerCallback('qb-crypto:server:SellCrypto', function(CryptoData)
--         cb(CryptoData)
--     end, data)
-- end)

-- RegisterNUICallback('TransferCrypto', function(data, cb)
--     HDCore.Functions.TriggerCallback('qb-crypto:server:TransferCrypto', function(CryptoData)
--         cb(CryptoData)
--     end, data)
-- end)

RegisterNetEvent('HD-phone:client:RemoveBankMoney')
AddEventHandler('HD-phone:client:RemoveBankMoney', function(amount)
    if PhoneData.isOpen then
...
RegisterNetEvent('HD-phone:client:AddTransaction')
AddEventHandler('HD-phone:client:AddTransaction', function(SenderData, TransactionData, Message, Title)
    local Data = {
    ...
    TriggerServerEvent('HD-phone:server:AddTransaction', Data)
end)

RegisterNUICallback('GetPlayerHouses', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end)
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)

RegisterNUICallback('RemoveKeyholder', function(data)
    TriggerServerEvent('HD-housing:server:remove:house:key', data.HouseData.name, data.HolderData.citizenid)
end)

RegisterNUICallback('SetHouseLocation', function(data, cb)
    SetNewWaypoint(data.HouseData.HouseData['Coords']['Enter']['X'], data.HouseData.HouseData['Coords']['Enter']['Y'])
    HDCore.Functions.Notify("Je GPS is ingesteld op " .. data.HouseData.HouseData['Adres'] .. "!", "info")
end)

RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    HDCore.Functions.TriggerCallback('HD-phone:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
...
RegisterNUICallback('SetGPSLocation', function(data, cb)
    ...
    HDCore.Functions.Notify('GPS is ingesteld!', 'success')
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    HDCore.Functions.TriggerCallback('HD-phone:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)
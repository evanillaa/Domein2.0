...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('http://HD-phone/RemoveKeyholder', JSON.stringify({
        HolderData: Data,
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('http://HD-phone/TransferCid', JSON.stringify({
        newBsn: NewBSN,
        HouseData: CurrentHouseData,
        ...
        if (CanTransfer) {
            ...
            QB.Phone.Notifications.Add("fas fa-home", "Huizen", "Dit is een ongeldig BSN-nummer", "#27ae60", 2500);

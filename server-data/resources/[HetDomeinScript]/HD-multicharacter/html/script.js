    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                $.post('http://HD-multicharacter/setupCharacters');
                $.post('http://HD-multicharacter/removeBlur');
...
$(document).on('click', '.character-box', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('http://HD-multicharacter/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("selected");
...
$(document).on('click', '#create-user', function(e){
    e.preventDefault();
    $.post('http://HD-multicharacter/createNewCharacter', JSON.stringify({
...
$(document).on('click', '#accept-delete', function(e){
    $.post('http://HD-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('http://HD-multicharacter/selectCharacter', JSON.stringify({

...
RegisterNetEvent('HD-spawn:client:choose:spawn')
AddEventHandler('HD-spawn:client:choose:spawn', function()
    Citizen.SetTimeout(1450, function()
...
RegisterNetEvent('HD-spawn:client:choose:appartment')
AddEventHandler('HD-spawn:client:choose:appartment', function()
...
RegisterNUICallback('ChooseAppartment', function(data)
    ...
    SetSkyCam(false)
    TriggerEvent('HDCore:Client:OnPlayerLoaded')
    TriggerServerEvent('HD-appartments:server:set:appartment:data', data.AppId)
end)
...
RegisterNUICallback('SpawnJail', function(data)
    ...
    TriggerEvent('HDCore:Client:OnPlayerLoaded')
    Citizen.Wait(100)
    TriggerEvent('HD-prison:client:spawn:prison')
end)

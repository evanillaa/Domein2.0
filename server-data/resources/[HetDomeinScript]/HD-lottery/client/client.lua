...
Citizen.CreateThread(function()
	while true do
       ...
       if Gebied <= 1.1 then
           NearSelling = true
		 	     DrawText3D(Config.Location['Coords']['X'], Config.Location['Coords']['Y'], Config.Location['Coords']['Z'] + 0.15, '~g~E~s~ - Kaarten Inleveren')
               ...
               TriggerServerEvent('HD-lottery:server:sell:card')
		 	     end
		   end
...
RegisterNetEvent('HD-lottery:client:open:card')
AddEventHandler('HD-lottery:client:open:card', function(id, prize)

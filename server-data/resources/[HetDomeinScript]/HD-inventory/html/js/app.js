...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id-card") {
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Pas-ID: </strong><span>' + itemData.info.id + '</span></p><p><strong>Voornaam: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Achternaam: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>INSZ: </strong><span>' + itemData.info.citizenid + '</span></p>');
        } else if (itemData.name == "hunting-card") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Voornaam: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Achternaam: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Geboortedatum: </strong><span>' + itemData.info.birthdate + '</span></p>');
            ...
            } else if (itemData.info.serie == undefined) {
                $(".item-info-description").html('<p>' + itemData.description + '</p>');
            } else if (itemData.ammotype == 'nil') {
                $(".item-info-description").html('<p>' + itemData.description + '</p>');
            } else {
            ...
            if (itemData.info.type == "casing") {
                ...
                $(".item-info-description").html('<p><strong>Bewijstuk: </strong><span>' + itemData.info.label + '</span></p><p><strong>Bloodgroep: </strong><span>' + itemData.info.bloodtype + '</span></p><p><strong>Plaats delict: </strong><span>' + itemData.info.street + '</span></p>');
            }else if (itemData.info.type == "fingerprint") {
                $(".item-info-description").html('<p><strong>Bewijstuk: </strong><span>' + itemData.info.label + '</span></p><p><strong>Vingerpatroon: </strong><span>' + itemData.info.fingerprint + '</span></p><p><strong>Plaats delict: </strong><span>' + itemData.info.street + '</span></p>');
            }else if (itemData.info.type == "hair") {
                $(".item-info-description").html('<p><strong>Bewijstuk: </strong><span>' + itemData.info.label + '</span></p><p><strong>Haar ID: </strong><span>' + itemData.info.hair + '</span></p><p><strong>Plaats delict: </strong><span>' + itemData.info.street + '</span></p>');
            } else if (itemData.info.type == "slime") {
                $(".item-info-description").html('<p><strong>Bewijstuk: </strong><span>' + itemData.info.label + '</span></p><p><strong>Slijm ID: </strong><span>' + itemData.info.slime + '</span></p><p><strong>Plaats delict: </strong><span>' + itemData.info.street + '</span></p>');
            }
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Medisch Bloed Monster: </strong><span>' + itemData.info.vialid + '</span></p><p><strong>Patiënt: </strong><span>' + itemData.info.vialname + '</span></p><p><strong>INSZ: </strong><span>' + itemData.info.vialbsn + '</span></p><p><strong>Bloed Type: </strong><span>' + itemData.info.bloodtype + '</span></p>' );
        } else if (itemData.name == "markedbills") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Waarde: </strong><span>€' + itemData.info.worth + '</span></p>');
        } else if (itemData.name == "paycheck") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Loon: </strong><span>€' + itemData.info.worth + '</span></p>');
        } else {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>' + itemData.description + '</p>')
        }

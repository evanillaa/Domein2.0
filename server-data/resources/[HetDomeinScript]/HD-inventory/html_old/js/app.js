...
$(document).on('click', '.weapon-attachments-back', function(e){
    e.preventDefault();
    $("#HDCore-inventory").css({"display":"block"});
    $("#HDCore-inventory").animate({
        left: 0+"vw"
    }, 200);
...
function FormatAttachmentInfo(data) {
    $.post("http://HD-inventory/GetWeaponData", JSON.stringify({
        weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post('http://HD-inventory/RemoveAttachment', JSON.stringify({
...
$(document).on('click', '#weapon-attachments', function(e){
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $("#HDCore-inventory").animate({
            ...
            $("#HDCore-inventory").css({"display":"none"})
        });
        $(".weapon-attachments-container").animate({
            left: 0+"vw"
        }, 200);
        ...
        $.post('http://HD-inventory/Notify', JSON.stringify({
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id-card") {
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Driver License: </strong><span>' + itemData.info.type + '</span></p>');
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html('<p><strong>Evidence Piece: </strong><span>' + itemData.info.label + '</span></p><p><strong>Type: </strong><span>' + itemData.info.ammotype + '</span></p><p><strong>Caliber: </strong><span>' + itemData.info.ammolabel + '</span></p><p><strong>Serial number: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Crime scene: </strong><span>' + itemData.info.street + '</span></p>');
            }else if (itemData.info.type == "blood") {
                $(".item-info-description").html('<p><strong>Evidence Piece: </strong><span>' + itemData.info.label + '</span></p><p><strong>Bloodgroup: </strong><span>' + itemData.info.bloodtype + '</span></p><p><strong>Crime scene: </strong><span>' + itemData.info.street + '</span></p>');
            }else if (itemData.info.type == "fingerprint") {
                $(".item-info-description").html('<p><strong>Evidence Piece: </strong><span>' + itemData.info.label + '</span></p><p><strong>Fingerprint: </strong><span>' + itemData.info.fingerprint + '</span></p><p><strong>Crime scene: </strong><span>' + itemData.info.street + '</span></p>');
            }else if (itemData.info.type == "hair") {
                $(".item-info-description").html('<p><strong>Evidence Piece: </strong><span>' + itemData.info.label + '</span></p><p><strong>Hair ID: </strong><span>' + itemData.info.hair + '</span></p><p><strong>Crime scene: </strong><span>' + itemData.info.street + '</span></p>');
            } else if (itemData.info.type == "slime") {
                $(".item-info-description").html('<p><strong>Evidence Piece: </strong><span>' + itemData.info.label + '</span></p><p><strong>Slime ID: </strong><span>' + itemData.info.slime + '</span></p><p><strong>Crime scene: </strong><span>' + itemData.info.street + '</span></p>');
            }
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Card value: $</strong><span>' + itemData.info.card + '</span></p>');
        } else if (itemData.name == "bloodvial") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Medisch Blood Sample: </strong><span>' + itemData.info.vialid + '</span></p><p><strong>Patiënt: </strong><span>' + itemData.info.vialname + '</span></p><p><strong>CID: </strong><span>' + itemData.info.vialbsn + '</span></p><p><strong>Blood Type: </strong><span>' + itemData.info.bloodtype + '</span></p>' );
        } else if (itemData.name == "markedbills") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Value: </strong><span>$' + itemData.info.worth + '</span></p>');
...
function handleDragDrop() {
    ...
    $(".item-slot").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://HD-inventory/UpdateStash", JSON.stringify({}));
        },
    });
    ...
    $("#item-use").droppable({
        ...
        drop: function(event, ui) {
            ...
            if(fromData.useable) {
                ...
                $.post("http://HD-inventory/UseItem", JSON.stringify({
    ...
    $(".item-slot").click(function(event) {
        if (event.shiftKey) {
            ...
            $.post('http://HD-inventory/UseItemShiftClick', JSON.stringify({
                slot: itemData.slot
            }));
        } 
    });
    ...
    $("#item-drop").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://HD-inventory/DropItem", JSON.stringify({
                inventory: fromInventory,
                item: fromData,
...
$(document).on('click', '.CombineItem', function(e){
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post('http://HD-inventory/combineWithAnim', JSON.stringify({
        ...
        $.post('http://HD-inventory/combineItem', JSON.stringify({
...
function optionSwitch($fromSlot, $toSlot, $fromInv, $toInv, $toAmount, toData, fromData) {
    ...
    $.post("http://HD-inventory/SetInventoryData", JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {       
        ...
        if((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            $.post("http://HD-inventory/PlayDropSound", JSON.stringify({}));
            $.post("http://HD-inventory/SetInventoryData", JSON.stringify({
                fromInventory: $fromInv.attr("data-inventory"),
                toInventory: $toInv.attr("data-inventory"),
                fromSlot: $fromSlot,
            ...
            if (fromData.amount == $toAmount) {
                if (toData != undefined && toData.combinable != null && isItemAllowed(fromData.name, toData.combinable.accept)) {
                    $.post('http://HD-inventory/getCombineItem', JSON.stringify({item: toData.combinable.reward}), function(item){
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("http://HD-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        $('#skill-lockpick').html('lvl ' + data.weedaddiction + '');
        $('#skill-hacking').html('lvl ' + data.cokeaddiction + '');
        $('#skill-robbery').html('lvl ' + data.alcoholaddiction + '');
        $('#skill-drugs').html('lvl ' + data.junkfoodaddiction + '');
        $("#HDCore-inventory").fadeIn(300);
    ...
    Inventory.Close = function() {
        ...
        $("#HDCore-inventory").fadeOut(300);
        $(".combine-option-container").hide();
        $(".item-slot").remove();
        if ($("#rob-money").length) {
            $("#rob-money").remove();
        }
        $.post("http://HD-inventory/CloseInventory", JSON.stringify({}));

        if (AttachmentScreenActive) {
            $("#HDCore-inventory").css({"left": "0vw"});
...
$(document).on('click', '#rob-money', function(e){
    ...
    $.post('http://HD-inventory/RobMoney', JSON.stringify({
        TargetId: TargetId
    }));
    $("#rob-money").remove();
});
...
Doorlock.Show = function(data) {
  ...
  if (data.text == 'closed') {
      CurrentClass = 'error'
      $notification.append('<div class="alert-detail"><span> Closed</span></div>');
  } else if (data.text == 'closed-auth') {
      CurrentClass = 'error'
      $notification.append('<div class="alert-detail"><span> [E] Locked</span></div>');
      ...
      CurrentClass = 'success'
      $notification.append('<div class="alert-detail"><span> [E] Unlocked</span></div>');
  }

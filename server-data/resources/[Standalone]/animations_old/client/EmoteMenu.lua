...
function AddCancelEmote(menu)
    local newitem = NativeUI.CreateItem("Stop Emote ", "~r~X~w~ Stops emote")
...
function AddWalkMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, "Walkstyles", "", "", Menuthing, Menuthing)
...
AddEventHandler('animations:client:ToggleMenu', function()
  if CanDoEmote then
    ...
    Cube.Functions.Notify("You can not do any emotes right now", "error")
  end
end)
